...
:
: 		This version of marcxml2madsrdf is only included here because MBIB-2-BIBFRAME-Shared.xqy calls it to get the subjects
:
:			WARNING! WARNING! WARNING! DO NOT EDIT THIS FILE EXPECTING THAT IT WILL RESULT IN GENERAL CHANGES TO MARCXML2MADSRDF
:			IT ONLY WILL AFFECT SUBJECTS IN THE BIBFRAME CONVERSION.
:
:
:
